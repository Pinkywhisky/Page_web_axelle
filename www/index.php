...
<head>
  ...
  <link rel="stylesheet" href="/assets/style.css?v=20260615-1" />
</head>
    ...
    <main>
      <section id="homeView">
        <section class="hero-section" id="home">
          <div class="hero-card">
            <div class="hero-copy">
              <h1>Parce que chaque patte tendue mérite qu'on lui tende la main.</h1>
              <p class="hero-text">
                Garde d'animaux, promenades et éducation canine :
                un accompagnement bienveillant pour aider votre compagnon à s'épanouir et vous permettre de partir
                l'esprit serein.
              </p>
        ...
        <section class="section-block about-section" id="about">
          <div class="section-center">
            ...
            <p class="section-text">
              Derrière le Club des Pattes, il y a avant tout une passion pour les animaux
              et l'envie de leur offrir l'attention, la patience et la bienveillance qu'ils méritent.
            </p>
          </div>

          <div class="about-content">
            <div class="about-photo">
              <img src="assets/axelle.jpg" alt="Photo Axelle" />
            </div>

            <div class="about-text">
              <h3>Bonjour, je suis Axelle</h3>

              <p>
                Passionnée par le monde animal depuis toujours, j'accompagne les familles
                dans la garde de leurs animaux, les promenades et l'éducation canine.
              </p>

              <p>
                Mon objectif est de créer une relation de confiance avec chaque animal
                afin qu'il se sente écouté, compris et accompagné dans le respect de son rythme.
              </p>

              <p>
                Parce que chaque patte tendue mérite qu'on lui tende la main, je mets
                tout en œuvre pour offrir à votre compagnon un environnement rassurant,
                sécurisant et adapté à ses besoins.
              </p>
              ...
              <div class="about-values">
                ...
                <div class="value-item">
                  <span>🌿</span>
                  <strong>Respect du rythme de l'animal</strong>
                </div>
              </div>
            </div>
          ...
          <div class="service-grid">
            <article class="service-card">
              ...
              <div class="service-content">
                <h3>Promenade</h3>
                <p>Bien plus qu'une simple sortie, chaque promenade est un moment privilégié pour votre compagnon.</p>

                <p>Je veille à lui offrir une activité adaptée à ses besoins : exploration, stimulation, exercice
                  physique et moments de détente. Chaque balade est pensée pour favoriser son équilibre, renforcer sa
                  confiance et répondre à ses besoins naturels.</p>

                <p>Votre chien profite ainsi d'un moment enrichissant, en toute sécurité et dans le respect de son
                  rythme.</p>
              </div>
            </article>
            <article class="service-card">
              <div class="service-image service-image-care" role="img" aria-label="Chien et chat dans un cadre naturel">
              </div>
              <div class="service-content">
                <h3>Garde chien & chat</h3>
                <p>Partir sereinement, c'est savoir que son compagnon est entre de bonnes mains.</p>

                <p>J'accueille votre chien ou votre chat à mon domicile dans un cadre chaleureux et bienveillant. Grâce
                  à
                  mon activité en télétravail, votre animal profite d'une présence quasi continue, de moments de
                  partage, d'attention et d'un accompagnement adapté à son caractère.</p>

                <p>Ici, pas de longues journées seul : chaque pensionnaire est considéré comme un membre temporaire de
                  la
                  famille et bénéficie d'un environnement pensé pour son bien-être et son équilibre.</p>
              </div>
            </article>
            <article class="service-card">
              ...
              <div class="service-content">
                ...
                <p>Chaque chien est unique et apprend à son rythme.</p>

                <p>Je propose un accompagnement bienveillant basé sur la compréhension du comportement canin, le
                  renforcement positif et le respect des besoins de votre compagnon. Mon objectif est de vous aider à
                  construire une relation harmonieuse fondée sur la confiance, la communication et la cohérence.</p>

                <p>Ensemble, nous travaillons les comportements du quotidien afin de favoriser un chien équilibré,
                  serein et épanoui.</p>
                </p>
              </div>
            </article>
        ...
        <section class="section-block testimonials-section" id="testimonials">
          ...
          <div class="testimonial-grid">
            ...
            <article class="testimonial-card">
              <p class="stars" aria-label="5 étoiles">★★★★★</p>
              <blockquote>"J'ai retrouvé toutes les informations importantes au même endroit. Très pratique."
              </blockquote>
      ...
      <section class="section-block manage-view" id="manageView" hidden>
        ...
        <div class="admin-tabs" id="manageTabs" role="tablist" aria-label="Administration">
          <button class="admin-tab is-active" id="adminDashboardTab" type="button" role="tab" aria-selected="true"
            aria-controls="adminDashboardPanel" data-admin-tab="dashboard">
            <span>Tableau de bord</span>
          </button>
          <button class="admin-tab" id="adminBookingsTab" type="button" role="tab" aria-selected="false"
            aria-controls="adminBookingsPanel" data-admin-tab="bookings">
            <span>Gardes</span>
            <span class="tab-badge" id="adminBookingsBadge" hidden>0</span>
          </button>
          <button class="admin-tab" id="adminUsersTab" type="button" role="tab" aria-selected="false"
            aria-controls="adminUsersPanel" data-admin-tab="users">
            <span>Membres</span>
            <span class="tab-badge tab-badge-muted" id="adminUsersBadge" hidden>0</span>
          </button>
          <button class="admin-tab" id="adminContactsTab" type="button" role="tab" aria-selected="false"
            aria-controls="adminContactsPanel" data-admin-tab="contacts">
            <span>Messages</span>
            <span class="tab-badge" id="adminContactsBadge" hidden>0</span>
          </button>
          <button class="admin-tab" id="adminArchivesTab" type="button" role="tab" aria-selected="false"
            aria-controls="adminArchivesPanel" data-admin-tab="archives">
            <span>Archives</span>
  ...
  <div class="modal-backdrop" id="profileModal" hidden>
    <div class="modal-card modal-wide" role="dialog" aria-modal="true" aria-labelledby="profileModalTitle">
      ...
      <div class="admin-tabs profile-tabs" id="profileTabs" role="tablist" aria-label="Profil client">
        <button class="admin-tab is-active" id="profilePetsTab" type="button" role="tab" aria-selected="true"
          aria-controls="profilePetsPanel" data-profile-tab="pets">Animaux</button>
        <button class="admin-tab" id="profileBookingsTab" type="button" role="tab" aria-selected="false"
          aria-controls="profileBookingsPanel" data-profile-tab="bookings">Gardes</button>
        <button class="admin-tab" id="profileContactsTab" type="button" role="tab" aria-selected="false"
          aria-controls="profileContactsPanel" data-profile-tab="contacts">Messages</button>
        <button class="admin-tab" id="profileDetailsTab" type="button" role="tab" aria-selected="false"
          aria-controls="profileDetailsPanel" data-profile-tab="details">Coordonnées</button>
      </div>

      <section class="profile-pets profile-tab-panel" id="profilePetsPanel" role="tabpanel"
        aria-labelledby="profilePetsTab">
        <div class="panel-card-top">
          <div>
            <h4>Mes animaux</h4>
      ...
      <section class="profile-bookings profile-tab-panel" id="profileBookingsPanel" role="tabpanel"
        aria-labelledby="profileBookingsTab" hidden>
        <div class="panel-card-top">
          <div>
      ...
      <section class="profile-bookings profile-tab-panel" id="profileContactsPanel" role="tabpanel"
        aria-labelledby="profileContactsTab" hidden>
        <div class="panel-card-top">
          <div>
            <h4>Mes messages</h4>
      ...
      <section class="profile-details profile-tab-panel" id="profileDetailsPanel" role="tabpanel"
        aria-labelledby="profileDetailsTab" hidden>
    ...
    <div class="modal-card modal-wide" role="dialog" aria-modal="true" aria-labelledby="bookingModalTitle">
      ...
      <form id="bookingForm" class="stack-form">
        ...
        <textarea id="bookingNotes" rows="4"
          placeholder="Habitudes, alimentation, médicaments, accès au domicile, remarques utiles."></textarea>
